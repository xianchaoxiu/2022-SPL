function [U,P1,P2] = SGCCA(X1,X2,r1,r2,d)
...
for iter = 1: maxit
        ...
        %  update Q1 and Q2
        Q1     = prox_l1(P1-Z1/beta,r1/beta);
        Q2     = prox_l1(P2-Z2/beta,r2/beta);        
       ...
       RelP1(iter+1) = norm(P1 - P1_ori,'fro')/norm(P1,'fro');
       RelP2(iter+1) = norm(P2 - P2_ori,'fro')/norm(P2,'fro');
